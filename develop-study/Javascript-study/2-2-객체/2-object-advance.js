...
// console.log(typeof article1); //object
// console.log(typeof viewCount); //number
// console.log(typeof article1.writer); //object
// console.log(typeof article1.writer.account); //string
// console.log(!article1.writer.emailVerify); //false
// console.log(`===========================`);
...
// // 프로퍼티 동적 추가: 실행중 프로퍼티 추가하기
// article1.isAdmin = false; //없으면 추가됨
// console.log(article1);
